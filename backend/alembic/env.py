...
# App imports: Base.metadata is the autogenerate target, and importing
# app.models registers every table on it. app.config supplies DATABASE_URL.
...
# Inject the runtime DATABASE_URL so we never hardcode credentials in the ini.
